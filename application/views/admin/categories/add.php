...
<div id="content">
	...
	<p>Add a new category by entering the information required below</p>
	...
	<div class="box-940">
		...
		<div class="box-940-content">
			...
			<div class="row">
				...
				<input type="submit" value="Add Category"/>&nbsp;<input type="button" onclick="location.href='/index.php/admin/categories';" value="Cancel"/>
